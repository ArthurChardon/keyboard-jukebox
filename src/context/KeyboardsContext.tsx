...
export function KeyboardContextProvider({ children }: { children: ReactNode }) {
  ...
  > = {
    ...
    alphabet: [
      { key: "1", label: "A-", ref: "a2", note: "A-" },
      { key: "2", label: "B-", ref: "b2", note: "B-" },
      { key: "3", label: "C", ref: "c3", note: "C" },
      { key: "4", label: "D", ref: "d3", note: "D" },
      { key: "5", label: "E", ref: "e3", note: "E" },
      { key: "6", label: "F", ref: "f3", note: "F" },
      { key: "7", label: "G", ref: "g3", note: "G" },
      { key: "8", label: "A", ref: "a3", note: "A" },
      { key: "9", label: "B", ref: "b3", note: "B" },
    ],
    complex: [
      { key: "A", label: "Do 3", ref: "c3", note: "C" },
      { key: "Z", label: "Re 3", ref: "d3", note: "D" },
      { key: "E", label: "Mi 3", ref: "e3", note: "E" },
      { key: "R", label: "Fa 3", ref: "f3", note: "F" },
      { key: "T", label: "Sol 3", ref: "g3", note: "G" },
      { key: "Y", label: "La 3", ref: "a3", note: "A" },
      { key: "U", label: "Si 3", ref: "b3", note: "B" },
      { key: "I", label: "Do 4", ref: "c4", note: "C+" },
      { key: "O", label: "Re 4 ", ref: "d4", note: "D+" },
      { key: "P", label: "Mi 4", ref: "e4", note: "E+" },
      { key: "1", label: "Do# 3", ref: "c3_diese", note: "C#" },
      { key: "2", label: "Re# 3", ref: "d3_diese", note: "D#" },
      { key: "4", label: "Fa# 3", ref: "f3_diese", note: "F#" },
      { key: "5", label: "Sol# 3", ref: "g3_diese", note: "G#" },
      { key: "6", label: "La# 3", ref: "a3_diese", note: "A#" },
    ],
  };
